...
stone_image1 = Image.open("D:\RPS GAME\img rock\download.jfif")
stone_image = ImageTk.PhotoImage(stone_image1)

paper_image1 = Image.open("D:\RPS GAME\paper img\paper_111691001.jpg")
paper_image = ImageTk.PhotoImage(paper_image1)

scissors_image1 = Image.open("D:\RPS GAME\scissor img\scissors-icon-260nw-337423679.webp")
